...
contract RealiumTokenV2 is Context, IERC20, IERC20Metadata, AccessControl, Pausable {
    ...
    function removeAllowedUserRole(address user) public onlyRole(ADMIN_ROLE){
        revokeRole(ALLOWED_USER_ROLE, user);
    }
     ...
     */
    function transfer(address recipient, uint256 amount) public virtual override onlyRole(ALLOWED_USER_ROLE) returns (bool) {
    ...
    function transferFrom(
        ...
        address recipient,
        uint256 amount
    ) public virtual override  onlyRole(ALLOWED_USER_ROLE) returns (bool) {
